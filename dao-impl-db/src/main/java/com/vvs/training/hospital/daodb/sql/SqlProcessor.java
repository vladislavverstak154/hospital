...
public class SqlProcessor<T> {
	...
	public String insertSql(){
		String sql=new String("INSERT INTO "+clazz.getSimpleName()+"("+columnNamesRow+") "+ "VALUES("+this.argPlaces+")");
		return sql;
	}
	
	public String updateSql(){
		String sql=new String("UPDATE "+clazz.getSimpleName()+" SET("+columnNamesRow+")"+"=("+this.argPlaces+")"+" WHERE id="+this.id);
		return sql;
	}
	
		
	public PreparedStatement setArgs(PreparedStatement statement) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		int i=1;
